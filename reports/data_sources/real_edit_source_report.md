...
| `anyedit_thinking_train` | apache-2.0 | reasoning_trace_candidate_not_default_pair_sample | reasoning_edit_bootstrap, critic_rationale_candidate | Reasoning-heavy AnyEdit subset with input/output images and thinking traces. Excluded from default long pair sampling until VLM pair-alignment checks verify same-image edit consistency. |
